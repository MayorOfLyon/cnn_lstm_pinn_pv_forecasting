...
def first_feature_engineering_wendu(train_old, test_old):
    ...
    train_old['year'] = train_old['时间'].dt.year.astype('int32')
    train_old['month'] = train_old['时间'].dt.month.astype('int32')
    train_old['day'] = train_old['时间'].dt.day.astype('int32')
    train_old['hour'] = train_old['时间'].dt.hour.astype('int32')   
    train_old['min'] = train_old['时间'].dt.minute.astype('int32')
    ...
    train_label = train_old['实际功率'] # label
    
    # label_1 = normalize(train_old['实发辐照度'])
    label_1 = train_old['实发辐照度']
    ...
    test_label = test_old['实际功率']
    
    test_old['year'] = test_old['时间'].dt.year.astype('int32')
    test_old['month'] = test_old['时间'].dt.month.astype('int32')
    test_old['day'] = test_old['时间'].dt.day.astype('int32')
    test_old['hour'] = test_old['时间'].dt.hour.astype('int32')
    test_old['min'] = test_old['时间'].dt.minute.astype('int32')
    
    test_features['month'] = normalize(test_old['month'])

    test_features['day'] = normalize(test_old['day'])
    ...
    return train_features, test_features, label_1, train_label, test_label, train_old['温度'], test_old['温度']